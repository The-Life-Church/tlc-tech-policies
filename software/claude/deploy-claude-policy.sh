...
#   Name: TLC Claude Code Policy · root · recurring daily · scope: all Claude Code Macs
#   Does: fetches the fleet CLAUDE.md to /etc/claude-code/ and wires the @import into
#   each user's ~/.claude/CLAUDE.md — installs no tools
# =============================================================================
#
